...
export function DashboardMobile({
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 font-sans selection:bg-[#1864FF]/20 text-slate-800 pb-20">
      
      {/* MOBILE HEADER */}
      <header className="flex items-center justify-between px-6 h-20 bg-white border-b border-slate-100 sticky top-0 z-10 shrink-0">
         <Logo />
                      ...
                      {!wallet ? (
                        ...
                        <>
                          <div className="bg-white p-4 rounded-xl border border-slate-200 inline-block">
                            <QrCode className="w-40 h-40 text-slate-900 mx-auto" strokeWidth={1} />
                          </div>
